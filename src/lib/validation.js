...
export const registerSchema = Joi.object({
  ...
  membershipCategory: Joi.string().valid('PRIMARY', 'SECONDARY', 'TERTIARY', 'ASSOCIATE', 'STAFF', 'ALUMNI').required(),
...
}).or('phoneNumber', 'email', 'identifier');
...
export const createMemberSchema = Joi.object({
  ...
  membershipCategory: Joi.string().valid('PRIMARY', 'SECONDARY', 'TERTIARY', 'ASSOCIATE', 'STAFF', 'ALUMNI').optional(),
